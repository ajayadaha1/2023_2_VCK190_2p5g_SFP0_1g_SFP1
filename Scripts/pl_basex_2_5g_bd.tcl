...
proc create_hier_cell_eth_1g { parentCell nameHier } {
  ...
  connect_bd_net -net axi_ethernet_t_interrupt [get_bd_pins axi_ethernet_t/interrupt] [get_bd_pins interrupt]
  connect_bd_net -net axi_ethernet_t_rxmcommaalignen_out [get_bd_pins axi_ethernet_t/rxmcommaalignen_out] [get_bd_pins rxmcommaalignen_out]
  connect_bd_net -net axi_ethernet_t_status_vector [get_bd_pins axi_ethernet_t/status_vector] [get_bd_pins status_vector]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_ethernet_t_status_vector]
  connect_bd_net -net cplllock_in_1 [get_bd_pins cplllock_in] [get_bd_pins axi_ethernet_t/cplllock_in]
  connect_bd_net -net gtpowergood_in_1 [get_bd_pins gtpowergood_in] [get_bd_pins axi_ethernet_t/gtpowergood_in]
  connect_bd_net -net gtwiz_reset_rx_done_in_1 [get_bd_pins gtwiz_reset_rx_done_in] [get_bd_pins axi_ethernet_t/gtwiz_reset_rx_done_in]
  connect_bd_net -net gtwiz_reset_tx_done_in_1 [get_bd_pins gtwiz_reset_tx_done_in] [get_bd_pins axi_ethernet_t/gtwiz_reset_tx_done_in]
  connect_bd_net -net m_axi_sg_aclk_1 [get_bd_pins m_axi_sg_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_ethernet_t/s_axi_lite_clk] [get_bd_pins axi_ethernet_t/axis_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk]
  connect_bd_net -net mmcm_locked_1 [get_bd_pins mmcm_locked] [get_bd_pins axi_ethernet_t/mmcm_locked] [get_bd_pins axi_ethernet_t/signal_detect]
  connect_bd_net -net pma_reset_1 [get_bd_pins pma_reset] [get_bd_pins axi_ethernet_t/pma_reset]
  connect_bd_net -net ref_clk_1 [get_bd_pins ref_clk] [get_bd_pins axi_ethernet_t/ref_clk]
  connect_bd_net -net rxuserclk2_1 [get_bd_pins rxuserclk2] [get_bd_pins axi_ethernet_t/rxuserclk2]
  connect_bd_net -net rxuserclk_1 [get_bd_pins rxuserclk] [get_bd_pins axi_ethernet_t/rxuserclk]
  connect_bd_net -net s_axi_lite_resetn_1 [get_bd_pins s_axi_lite_resetn] [get_bd_pins axi_ethernet_t/s_axi_lite_resetn] [get_bd_pins axi_dma_0/axi_resetn]
  connect_bd_net -net userclk2_1 [get_bd_pins userclk2] [get_bd_pins axi_ethernet_t/userclk2]
  connect_bd_net -net userclk_1 [get_bd_pins userclk] [get_bd_pins axi_ethernet_t/userclk]
...
proc create_hier_cell_axi_ethernet_t_gt_wrapper { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type gt_usrclk usrclk4
...
pl_basex_2_5g_gt_bridge_ip_0_1./gt_bridge_ip_1/GT_TX0.0 /axi_ethernet_t_gt_wrapper/gt_quad_base_0/RX2_GT_IP_Interface pl_basex_2_5g_gt_bridge_ip_0_0./gt_bridge_ip_0/GT_RX0.0 /axi_ethernet_t_gt_wrapper/gt_quad_base_0/RX3_GT_IP_Interface\
pl_basex_2_5g_gt_bridge_ip_0_1./gt_bridge_ip_1/GT_RX0.0} \
    CONFIG.GT_TYPE {GTY} \
...
ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET K28.5 RX_COMMA_VALID_ONLY 0 GT_TYPE GTY} \
    ...
    CONFIG.PROT_OUTCLK_VALUES {CH0_RXOUTCLK 390.625 CH0_TXOUTCLK 390.625 CH1_RXOUTCLK 390.625 CH1_TXOUTCLK 390.625 CH2_RXOUTCLK 156.25 CH2_TXOUTCLK 312.5 CH3_RXOUTCLK 156.25 CH3_TXOUTCLK 312.5} \
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/axi_ethernet_t_gt_wrapper/gt_quad_base_0 {/axi_ethernet_t_gt_wrapper/gt_quad_base_0 undef,undef,pl_basex_2_5g_gt_bridge_ip_0_0.IP_CH0,pl_basex_2_5g_gt_bridge_ip_0_1.IP_CH0\
MSTRCLK 0,0,1,1 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/axi_ethernet_t_gt_wrapper/gt_quad_base_0 {/axi_ethernet_t_gt_wrapper/gt_quad_base_0 undef,undef,pl_basex_2_5g_gt_bridge_ip_0_0.IP_CH0,pl_basex_2_5g_gt_bridge_ip_0_1.IP_CH0\
MSTRCLK 0,0,1,1 IS_CURRENT_QUAD 1}}} \
    CONFIG.REFCLK_LIST {{/CLK_IN_D_0_clk_p[0]} /gtrefclk_p_0} \
    CONFIG.REFCLK_STRING {HSCLK1_LCPLLGTREFCLK0 refclk_PROT0_R0_PROT1_R0_156.25_MHz_unique1} \
  ...
  set_property CONFIG.FREQ_HZ {125000000} $bufg_gt_4
  ...
  set_property CONFIG.FREQ_HZ {62500000} $bufg_gt_6
  ...
  set_property CONFIG.FREQ_HZ {62500000} $bufg_gt_7
  ...
  connect_bd_net -net apb3clk_0_1 [get_bd_pins apb3clk_0] [get_bd_pins gt_quad_base_0/apb3clk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk]
  connect_bd_net -net bufg_gt_0_usrclk [get_bd_pins bufg_gt_0/usrclk] [get_bd_pins gt_quad_base_0/ch0_txusrclk] [get_bd_pins gt_quad_base_0/ch2_txusrclk] [get_bd_pins gt_quad_base_0/ch0_rxusrclk] [get_bd_pins gt_quad_base_0/ch2_rxusrclk] [get_bd_pins usrclk]
  ...
  connect_bd_net -net bufg_gt_4_usrclk [get_bd_pins bufg_gt_4/usrclk] [get_bd_pins usrclk2] [get_bd_pins gt_quad_base_0/ch3_txusrclk]
  connect_bd_net -net bufg_gt_5_usrclk [get_bd_pins bufg_gt_5/usrclk] [get_bd_pins usrclk3] [get_bd_pins gt_quad_base_0/ch3_rxusrclk]
  connect_bd_net -net bufg_gt_6_usrclk [get_bd_pins bufg_gt_6/usrclk] [get_bd_pins usrclk4]
  connect_bd_net -net bufg_gt_7_usrclk [get_bd_pins bufg_gt_7/usrclk] [get_bd_pins usrclk5]
  connect_bd_net -net ch2_iloreset_1 [get_bd_pins ch2_iloreset] [get_bd_pins gt_quad_base_0/ch2_iloreset]
  connect_bd_net -net ch3_iloreset_1 [get_bd_pins ch3_iloreset] [get_bd_pins gt_quad_base_0/ch3_iloreset]
  ...
  connect_bd_net -net gt_quad_base_0_ch3_rxoutclk [get_bd_pins gt_quad_base_0/ch3_rxoutclk] [get_bd_pins bufg_gt_5/outclk] [get_bd_pins bufg_gt_6/outclk]
  connect_bd_net -net gt_quad_base_0_ch3_rxprogdivresetdone [get_bd_pins gt_quad_base_0/ch3_rxprogdivresetdone] [get_bd_pins ch3_rxprogdivresetdone]
  connect_bd_net -net gt_quad_base_0_ch3_txoutclk [get_bd_pins gt_quad_base_0/ch3_txoutclk] [get_bd_pins bufg_gt_4/outclk] [get_bd_pins bufg_gt_7/outclk]
  connect_bd_net -net gt_quad_base_0_ch3_txprogdivresetdone [get_bd_pins gt_quad_base_0/ch3_txprogdivresetdone] [get_bd_pins ch3_txprogdivresetdone]
  connect_bd_net -net gt_quad_base_0_gtpowergood [get_bd_pins gt_quad_base_0/gtpowergood] [get_bd_pins gtpowergood]
  connect_bd_net -net gt_quad_base_0_hsclk0_lcplllock [get_bd_pins gt_quad_base_0/hsclk0_lcplllock] [get_bd_pins hsclk0_lcplllock]
  connect_bd_net -net gt_quad_base_0_hsclk0_rplllock [get_bd_pins gt_quad_base_0/hsclk0_rplllock] [get_bd_pins hsclk0_rplllock]
  ...
  connect_bd_net -net hsclk0_lcpllreset_1 [get_bd_pins hsclk0_lcpllreset] [get_bd_pins gt_quad_base_0/hsclk0_lcpllreset]
  connect_bd_net -net hsclk1_lcpllreset_1 [get_bd_pins hsclk1_lcpllreset] [get_bd_pins gt_quad_base_0/hsclk1_lcpllreset]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins util_ds_buf_0/IBUF_OUT] [get_bd_pins gt_quad_base_0/GT_REFCLK0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins bufg_gt_0/gt_bufgtclr] [get_bd_pins bufg_gt_1/gt_bufgtclr] [get_bd_pins bufg_gt_2/gt_bufgtclr] [get_bd_pins bufg_gt_3/gt_bufgtclr] [get_bd_pins gt_quad_base_0/ch1_txusrclk] [get_bd_pins gt_quad_base_0/ch1_rxusrclk] [get_bd_pins gt_quad_base_0/altclk]
...
RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE TX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET K28.5 RX_COMMA_VALID_ONLY 0 } \
  ...
  # Create port connections
  connect_bd_net -net axi_ethernet_t_gt_wrapper_ch0_rxprogdivresetdone_ext [get_bd_pins gt_bridge_ip_0/ch0_rxprogdivresetdone_ext] [get_bd_pins axis_ila_1/probe0] [get_bd_pins eth_2p5g/gtwiz_reset_rx_done_in]
  connect_bd_net -net axi_ethernet_t_gt_wrapper_hsclk0_lcplllock [get_bd_pins axi_ethernet_t_gt_wrapper/hsclk0_lcplllock] [get_bd_pins eth_2p5g/cplllock_in] [get_bd_pins gt_bridge_ip_0/gt_lcpll_lock]
  connect_bd_net -net axi_ethernet_t_gt_wrapper_rxuserclk [get_bd_pins axi_ethernet_t_gt_wrapper/rxuserclk] [get_bd_pins axis_ila_1/probe1] [get_bd_pins eth_2p5g/rxuserclk]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_ethernet_t_gt_wrapper_rxuserclk]
  connect_bd_net -net axi_ethernet_t_gt_wrapper_userclk2 [get_bd_pins axi_ethernet_t_gt_wrapper/userclk2] [get_bd_pins axis_ila_1/probe2] [get_bd_pins eth_2p5g/userclk2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_ethernet_t_gt_wrapper_userclk2]
  connect_bd_net -net axi_ethernet_t_gt_wrapper_usrclk [get_bd_pins axi_ethernet_t_gt_wrapper/usrclk] [get_bd_pins axis_ila_1/probe3] [get_bd_pins eth_2p5g/userclk] [get_bd_pins gt_bridge_ip_0/gt_txusrclk] [get_bd_pins gt_bridge_ip_0/gt_rxusrclk]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_ethernet_t_gt_wrapper_usrclk]
  connect_bd_net -net axi_ethernet_t_gt_wrapper_usrclk1 [get_bd_pins axi_ethernet_t_gt_wrapper/usrclk1] [get_bd_pins axis_ila_1/probe4] [get_bd_pins eth_2p5g/rxuserclk2]
  ...
  connect_bd_net -net cips_0_pl0_ref_clk [get_bd_pins cips_0/pl0_ref_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins cips_0/m_axi_fpd_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins axi_noc_0/aclk8] [get_bd_pins axi_ethernet_t_gt_wrapper/apb3clk_0] [get_bd_pins axis_ila_1/clk] [get_bd_pins pma_reset_handler_0/clk] [get_bd_pins eth_2p5g/m_axi_sg_aclk] [get_bd_pins eth_1g/m_axi_sg_aclk] [get_bd_pins gt_bridge_ip_0/apb3clk] [get_bd_pins gt_bridge_ip_1/apb3clk]
  ...
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins axis_ila_0/clk] [get_bd_pins eth_2p5g/ref_clk] [get_bd_pins eth_1g/ref_clk]
  connect_bd_net -net cplllock_in_1 [get_bd_pins axi_ethernet_t_gt_wrapper/hsclk0_rplllock] [get_bd_pins eth_1g/cplllock_in] [get_bd_pins gt_bridge_ip_1/gt_lcpll_lock]
  connect_bd_net -net eth_1g_interrupt [get_bd_pins eth_1g/interrupt] [get_bd_pins cips_0/pl_ps_irq5]
  connect_bd_net -net eth_1g_mm2s_introut [get_bd_pins eth_1g/mm2s_introut] [get_bd_pins cips_0/pl_ps_irq3]
  connect_bd_net -net eth_1g_s2mm_introut [get_bd_pins eth_1g/s2mm_introut] [get_bd_pins cips_0/pl_ps_irq4]
  connect_bd_net -net eth_1g_status_vector [get_bd_pins eth_1g/status_vector] [get_bd_pins axis_ila_0/probe1]
  connect_bd_net -net eth_2p5g_interrupt [get_bd_pins eth_2p5g/interrupt] [get_bd_pins cips_0/pl_ps_irq2]
  connect_bd_net -net eth_2p5g_mm2s_introut [get_bd_pins eth_2p5g/mm2s_introut] [get_bd_pins cips_0/pl_ps_irq0]
  connect_bd_net -net eth_2p5g_rxmcommaalignen_out [get_bd_pins eth_2p5g/rxmcommaalignen_out] [get_bd_pins rxcommaalignen_out_s_0/rxcommaalignen_in]
  connect_bd_net -net eth_2p5g_s2mm_introut [get_bd_pins eth_2p5g/s2mm_introut] [get_bd_pins cips_0/pl_ps_irq1]
  connect_bd_net -net gt_bridge_ip_0_gt_ilo_reset [get_bd_pins gt_bridge_ip_0/gt_ilo_reset] [get_bd_pins axi_ethernet_t_gt_wrapper/ch2_iloreset]
  connect_bd_net -net gt_bridge_ip_0_gt_pll_reset [get_bd_pins gt_bridge_ip_0/gt_pll_reset] [get_bd_pins axi_ethernet_t_gt_wrapper/hsclk0_lcpllreset]
  connect_bd_net -net gt_bridge_ip_0_rx_resetdone_out [get_bd_pins gt_bridge_ip_0/rx_resetdone_out] [get_bd_pins pma_reset_handler_0/reset_done]
  connect_bd_net -net gt_bridge_ip_1_gt_ilo_reset [get_bd_pins gt_bridge_ip_1/gt_ilo_reset] [get_bd_pins axi_ethernet_t_gt_wrapper/ch3_iloreset]
  connect_bd_net -net gt_bridge_ip_1_gt_pll_reset [get_bd_pins gt_bridge_ip_1/gt_pll_reset] [get_bd_pins axi_ethernet_t_gt_wrapper/hsclk1_lcpllreset]
  connect_bd_net -net gt_quad_base_0_ch0_txprogdivresetdone [get_bd_pins gt_bridge_ip_0/ch0_txprogdivresetdone_ext] [get_bd_pins axis_ila_1/probe5] [get_bd_pins eth_2p5g/gtwiz_reset_tx_done_in]
  connect_bd_net -net gt_quad_base_0_gtpowergood [get_bd_pins axi_ethernet_t_gt_wrapper/gtpowergood] [get_bd_pins axis_ila_1/probe6] [get_bd_pins eth_2p5g/gtpowergood_in] [get_bd_pins eth_1g/gtpowergood_in] [get_bd_pins gt_bridge_ip_0/gtpowergood] [get_bd_pins gt_bridge_ip_1/gtpowergood]
  ...
  connect_bd_net -net gtwiz_reset_rx_done_in_1 [get_bd_pins axi_ethernet_t_gt_wrapper/ch3_rxprogdivresetdone] [get_bd_pins eth_1g/gtwiz_reset_rx_done_in]
  connect_bd_net -net gtwiz_reset_tx_done_in_1 [get_bd_pins axi_ethernet_t_gt_wrapper/ch3_txprogdivresetdone] [get_bd_pins eth_1g/gtwiz_reset_tx_done_in]
  connect_bd_net -net pma_reset_0_1 [get_bd_pins util_vector_logic_0/Res] [get_bd_pins axis_ila_1/probe7] [get_bd_pins pma_reset_handler_0/rst] [get_bd_pins eth_2p5g/pma_reset] [get_bd_pins eth_1g/pma_reset] [get_bd_pins gt_bridge_ip_0/gtreset_in] [get_bd_pins gt_bridge_ip_1/gtreset_in]
  connect_bd_net -net pma_reset_handler_0_pma_reset [get_bd_pins pma_reset_handler_0/pma_reset] [get_bd_pins gt_bridge_ip_0/reset_rx_datapath_in]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_1/Op1] [get_bd_pins axi_ethernet_t_gt_wrapper/apb3presetn] [get_bd_pins eth_2p5g/s_axi_lite_resetn] [get_bd_pins eth_1g/s_axi_lite_resetn]
  ...
  connect_bd_net -net rxuserclk2_1 [get_bd_pins axi_ethernet_t_gt_wrapper/usrclk4] [get_bd_pins eth_1g/rxuserclk2]
  connect_bd_net -net rxuserclk_1 [get_bd_pins axi_ethernet_t_gt_wrapper/usrclk3] [get_bd_pins eth_1g/rxuserclk]
  connect_bd_net -net status_vector [get_bd_pins eth_2p5g/status_vector] [get_bd_pins axis_ila_0/probe0] [get_bd_pins pma_reset_handler_0/status_vector]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets status_vector]
  connect_bd_net -net userclk2_1 [get_bd_pins axi_ethernet_t_gt_wrapper/usrclk2] [get_bd_pins eth_1g/userclk2]
  connect_bd_net -net userclk_2 [get_bd_pins axi_ethernet_t_gt_wrapper/usrclk5] [get_bd_pins eth_1g/userclk] [get_bd_pins gt_bridge_ip_1/gt_txusrclk] [get_bd_pins gt_bridge_ip_1/gt_rxusrclk]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins util_vector_logic_1/Res] [get_bd_pins clk_wiz/reset]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins eth_2p5g/mmcm_locked] [get_bd_pins eth_1g/mmcm_locked]
